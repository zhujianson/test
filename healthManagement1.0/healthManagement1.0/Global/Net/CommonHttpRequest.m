...
//    HMHomeViewController *myDefautVC = (HMHomeViewController *)(APP_DELEGATE2.window.rootViewController);
//    if (![myDefautVC isKindOfClass:[HMHomeViewController class]])
//    {
//        return;
//    }
...
//    dataUTF8 = [dataUTF8 stringByReplacingOccurrencesOfString:@"," withString:@"%2C"];
    ...
    if (isBy) {
        encodedString = [encodedString stringByAppendingString:VERSION_CHANNEL_KEY];
    }
                     ...
                     title:(NSString*)title
{
    ...
    [head setObject:@CLIENT_TYPE forKey:@"clientType"];
...
//                                dispatch_async( dispatc0h_get_main_queue(), ^(void){
