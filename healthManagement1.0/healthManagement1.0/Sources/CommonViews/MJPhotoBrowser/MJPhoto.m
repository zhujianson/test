...
- (void)setSrcView:(id)srcImageView
{
    ...
    else if ([srcImageView isKindOfClass:[UIButton class]])
    {
        imageView = ((UIButton*)srcImageView).imageView;
    }
    
    [self setSrcImageView:imageView];
}
