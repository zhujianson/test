...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPayWithDict:(NSDictionary *)payDcit
{
    //订单标题，展示给用户
    NSString *order_name    = payDcit[kProductName];
    //订单金额,单位（分）
    NSString *order_price   =  payDcit[kTotalAmount];//1分钱测试
    //================================
    //预付单参数订单设置
    //================================
    ...
    [packageParams setObject: @"APP-002"        forKey:@"device_info"]; //支付设备号或门店号
