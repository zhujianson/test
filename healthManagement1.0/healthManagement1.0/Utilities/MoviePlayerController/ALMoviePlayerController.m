...
- (void)setFullscreen:(BOOL)fullscreen animated:(BOOL)animated {
    ...
    if (fullscreen) {
        [(TopicDetailsViewController *)self.delegate hideStatusBar];
...
//            UIInterfaceOrientation currentOrientation = [[UIApplication sharedApplication] statusBarOrientation];
            [self rotateMoviePlayerForOrientation:UIInterfaceOrientationLandscapeRight animated:NO completion:^{
               ...
               [self.controls hidenCloseButton];
        }];
        
    } else {
        [(TopicDetailsViewController *)self.delegate showStatusBar];
