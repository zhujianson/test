...
- (void)setTheSlideType:(slideTitleType)theSlideType
{
    ...
    if(_theSlideType == SegmentType){
        self.titleNorColor = [CommonImage colorWithHexString:COLOR_FF5351];
        self.titleSelColor = [UIColor whiteColor];
        self.btnNorColor = [CommonImage colorWithHexString:Color_fafafa];
        self.btnSelColor = [CommonImage colorWithHexString:COLOR_FF5351];
    }else{
        self.titleNorColor = [CommonImage colorWithHexString:COLOR_333333];
        self.titleSelColor = [CommonImage colorWithHexString:COLOR_FF5351];
        self.btnNorColor = [CommonImage colorWithHexString:Color_fafafa];
...
- (void)resizeTitleScrollViewFrame
{
    ...
    titleScrollView.layer.borderColor = [[CommonImage colorWithHexString:COLOR_FF5351] CGColor];
...
- (void)getSegmentView:(int)index
{
    ...
    for(int i = 0; i < _titlesArray.count; i++){
        ...
        if (i != _titlesArray.count-1) {
            ...
            viewXian.backgroundColor = [CommonImage colorWithHexString:COLOR_FF5351];
        ...
        if(i == index){
            [button setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
             button.backgroundColor = [CommonImage colorWithHexString:COLOR_FF5351];
