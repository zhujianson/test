...
- (UIImage *)imageFromCell:(UICollectionViewCell *)cell {
    CGSize cellSize = CGSizeMake(cell.bounds.size.width-1, cell.bounds.size.width-1);
    UIGraphicsBeginImageContextWithOptions(cellSize, cell.isOpaque, 0.0f);
...
- (void)handleLongPressGesture:(UILongPressGestureRecognizer *)sender
{
    ...
    switch (sender.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            mockCell.layer.borderColor = [CommonImage colorWithHexString:VERSION_BACKGROUD_COLOR2].CGColor;
            mockCell.layer.borderWidth = 0.5;
        ...
        case UIGestureRecognizerStateCancelled: {
            ...
            NSLog(@"--------moveItemAtIndexPath \n, fromIndexPath--%@ \n,toIndexPath---%@\n hideIndexPath---%@",fromIndexPath,toIndexPath,self.layoutHelper.hideIndexPath);
...
- (void)warpToIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.layoutHelper.fromIndexPath.section == indexPath.section)
    {
        [self.collectionView performBatchUpdates:^{
            self.layoutHelper.hideIndexPath = indexPath;
            self.layoutHelper.toIndexPath = indexPath;
...
- (void)handlePanGesture:(UIPanGestureRecognizer *)sender
{
    if(sender.state == UIGestureRecognizerStateChanged) {
        ...
        if (canScroll) {
//              NSLog(@"------%@",NSStringFromCGRect(mockCell.frame));
