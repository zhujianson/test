...
- (void)createPerfect
{
    ...
    m_infoDic = [[NSMutableDictionary alloc]initWithObjectsAndKeys:@"",@"nickName",@"男",@"sex",@"",@"birthday",@"",@"Diabetes",@"",@"time",@"无",@"complications",@"无",@"history", nil];
...
- (void)withdraw:(UIButton*)btn
{
    ...
    [dic setObject:[LocationManager sharedManager].localCityString forKey:@"district"];
