...
//    data = [Common uncompressZippedData:data];
    
    NSString *strTest = [[NSString alloc] initWithBytes:[data bytes] length:[data length] encoding:[self responseEncoding]];
    
    NSString *strTest1 = [strTest stringByReplacingOccurrencesOfString:@"+" withString:@"%20"];
    [strTest release];
    NSString *str = [strTest1 stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    
//    NSString *newString = (NSString *)CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault,
//                                                  (CFStringRef)strTest, NULL,
//                                                  CFSTR(":?/#[]@!$ &'()*+,;=\"<>%{}|\\^~`"),
//                                                  kCFStringEncodingUTF8);
//    NSString *str = [newString stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
//    [strTest release];
